...
import uni.uni.fragments.AboutFragment;
import uni.uni.fragments.HelpFragment;
import uni.uni.fragments.MyNetworkFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String TAG_MYNETWORK = "mynetwork";
    public static final String TAG_NETWORKS = "networks";
    private static final String TAG_HELP = "help";
    private static final String TAG_ABOUT = "about";
    public static final String TAG_NETWORKINFO = "networkinfo";
    public static String CURRENT_TAG = TAG_MYNETWORK;
